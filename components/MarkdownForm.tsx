  ...
  return (
    <div className={`max-w-2xl mx-auto p-6 rounded-lg shadow-lg animate-fade-in-down ${darkMode ? 'bg-gray-800 text-white' : 'bg-gradient-to-r from-purple-500 to-blue-500 text-white'}`}>
      ...
      <textarea
        ...
        className={`w-full p-4 mb-4 border rounded-md focus:outline-none focus:ring-2 transition-all ${
      ...
      <div
        className={`prose prose-xl border p-6 rounded-md mb-6 shadow-lg overflow-auto max-h-96 transition-all custom-scrollbar ${
      ...
      <div className="flex justify-center gap-4">
        ...
        <PDFButton htmlOutput={htmlOutput} darkMode={darkMode} />
      </div>
    </div>
  );
};
